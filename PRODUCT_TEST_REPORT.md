...
| Low | Visual baselines inherited the host operating system’s UI-font fallback, producing different desktop text rasterization in GitHub Actions. | Pin Arial only inside the screenshot assertion; production typography and the strict pixel-difference tolerance remain unchanged. | Local and CI 375px/1440px baselines. |
